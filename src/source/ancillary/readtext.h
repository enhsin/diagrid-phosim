...
namespace readtext {
    ...
    public:
        ...
        template <class T> static void get(const std::string & line, const std::string & key, T & value) {(void) getKey<T>(line,key,value);};
        template <class T> static void get(const std::string & line, const std::string & key, std::vector<T> & value) {(void) getKeyVector<T>(line,key,value);};
        template <class T> static void get(const std::string & line, const std::string & key, std::vector<std::vector<T> > & value) {(void) getKeyMatrix<T>(line,key,value);};
