...
mm=double(mm)
point=point*13.3/60.*13.3/60./(!Pi*2.1*2.1)
diffuse=diffuse*13.3/60.*13.3/60./(!Pi*2.1*2.1)
...
for ii=0,N_elements(mm)-1 do begin
   ...
   for jj=0L,nn-1 do begin
      ra=randomu(seed,1)*13.3/60.0-6.65/60.0
      dec=randomu(seed,1)*13.3/60.0-6.65/60.0
